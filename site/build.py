...
J["acts"] = [
    ('Event', '2026/11', 'jsda-11th-2026.jpg', 'BAKEBAKE in デジタルアーカイブ学会', 'デジタルアーカイブ学会 第11回研究大会にて、BAKEBAKEメンバーの池辺莉々（日本女子大学）が発表する予定です。大会は2026年11月7日（土）・8日（日）、近畿大学 東大阪キャンパスで開催されます。\n\n発表では、日常の不思議な出来事や、うまく言葉にできない不安・違和感を、妖怪の名前や説明文、画像として表す「妖怪生成装置」を紹介します。国際日本文化研究センターの「怪異・妖怪伝承データベース」から関連する伝承を探し、生成AIが提案する候補を利用者自身が選んだり、修正したりしながら、自分の体験を形にしていく仕組みです。\n\n展示での実践をもとに、日常の体験を入口としてデジタルアーカイブに触れる可能性を考えます。あわせて、生成された妖怪と参照した伝承のつながりをどう伝えるか、元の記録へどう遡れるようにするかなど、アーカイブを生成AIと組み合わせて活用する際の課題についても報告する予定です。\n\n発表題目：デジタルアーカイブを基盤とした不可解な体験の記述に向けた妖怪生成システムの開発<br>―生成AIと妖怪・怪異データベースを用いた実践と課題―\n\n発表者：池辺莉々<br>共同著者：一倉弘毅、干川未来、清水紘輔', ('https://taikai.digitalarchivejapan.org/11th/', 'デジタルアーカイブ学会 第11回研究大会 公式サイト')),
...
E["acts"] = [
    ('Event', '2026/11', 'jsda-11th-2026.jpg', 'BAKEBAKE at the Japan Society for Digital Archive', 'BAKEBAKE member Riri Ikebe of Japan Women’s University is scheduled to present at the 11th Annual Meeting of the Japan Society for Digital Archive. The meeting will take place on November 7–8, 2026, at Kindai University’s Higashiosaka Campus.\n\nThe presentation will introduce our yōkai-generating apparatus, which helps people express strange everyday experiences, anxieties, and feelings that are hard to put into words through names, descriptions, and images of yōkai. It retrieves related stories from the Kaii-Yokai Folklore Database maintained by the International Research Center for Japanese Studies. Participants then choose or revise suggestions from generative AI to give form to their experiences.\n\nDrawing on our exhibition practice, the talk will explore how personal experiences can become an entry point into digital archives. It will also discuss how to show the relationship between generated works and the folklore they reference, and how to let users trace those works back to the original records.\n\nTalk title: Developing a Yōkai Generation Interface to Describe Inexplicable Experiences via Digital Archives<br>Practical Challenges in Constructing a Platform with Generative AI and a Yōkai-Kaii Database\n\nPresenter: Riri Ikebe<br>Co-authors: Hiroki Ichikura, Mirai Hoshikawa, Kosuke Shimizu', ('https://taikai.digitalarchivejapan.org/11th/', '11th Annual Meeting official website (Japanese)')),
...
ACT_SUMMARIES = {'ja': {'jsda-11th-2026': '池辺莉々がデジタルアーカイブ学会 第11回研究大会で発表予定です。妖怪生成装置の実践と、伝承アーカイブを生成AIと組み合わせて活用する際の課題を紹介します。', 'siggraph-asia-2026': 'SIGGRAPH Asia 2026に出展します。あなたの体験から妖怪が生まれる「妖怪生成装置」を紹介します。', 'foss4g-2026': '約3万3千件の妖怪伝承から、物語と場所のつながりを読み解く研究を紹介しました。'}, 'en': {'jsda-11th-2026': 'Riri Ikebe is scheduled to present our yōkai-generating apparatus and the challenges of connecting folklore archives with generative AI at the 11th Annual Meeting.', 'siggraph-asia-2026': 'We’re exhibiting at SIGGRAPH Asia 2026! Discover an apparatus that turns your experiences into yōkai.', 'foss4g-2026': 'Exploring the links between stories and places through more than 33,000 records of Japanese yōkai folklore.'}}

WORK_SLUGS = ["apparatus", "map", "search", "xr"]
ACT_SLUGS = ["jsda-11th-2026", "siggraph-asia-2026", "foss4g-2026", "yokai-expo-2026", "jsda-2026", "shonan-shirayuri", "xr-kaigi", "xr-meetup-aichi"]
...
def page_index(lang):
    ...
    w = t["works"]; a = t["acts"]
    pick = [card(root, assets, a[0][0], a[0][1], a[0][2], a[0][3], f"activities/{ACT_SLUGS[0]}.html"),
            card(root, assets, a[1][0], a[1][1], a[1][2], a[1][3], f"activities/{ACT_SLUGS[1]}.html"),
